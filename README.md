...
- Web editor where save publishes to readers, with pt-based title/body type settings and line-height control
...
The public page reads published posts only. The admin page can list titles, open writing, change title/body sizes in `pt`, adjust line height, and save the article body plus type settings. Saving from the admin page publishes that article to readers.
